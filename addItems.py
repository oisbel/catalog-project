...
artist0 = Artist(name="Lauren Daigle", picture = "http://iscale.iheart.com/v3/catalog/artist/30480349?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track1 = Track(title = "Trust In You",
       lyrics = content,
...
content= f.read()
f.close()
track2 = Track(title = "How Can It Be",
       lyrics = content,
...
content= f.read()
f.close()
track3 = Track(title = "Come Alive (Dry Bones)",
       lyrics = content,
...
artist1 = Artist(name="Hillsong Worship", picture = "iscale.iheart.com/v3/catalog/artist/30412158?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track0 = Track(title = "What A Beautiful Name",
       lyrics = content,
...
content= f.read()
f.close()
track1 = Track(title = "Here I Am To Worship",
       lyrics = content,
...
artist2 = Artist(name="Chris tomlin", picture = "iscale.iheart.com/v3/catalog/artist/28429?ops=fit(240%2C240),run(%22circle%22)+9")
...
content= f.read()
f.close()
track1 = Track(title = "How Great Is Our God",
       lyrics = content,
...
artist3 = Artist(name="Casting Crowns", picture = "iscale.iheart.com/v3/catalog/artist/89484?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track2 = Track(title = "Praise You In This Storm",
       lyrics = content,
...
# Tracks for MercyMe
artist4 = Artist(name="MercyMe", picture = "iscale.iheart.com/v3/catalog/artist/90180?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track1 = Track(title = "I Can Only Imagine",
       lyrics = content,
...
artist5 = Artist(name="For KING & COUNTRY", picture = "iscale.iheart.com/v3/catalog/artist/649143?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track1 = Track(title = "O God Forgive Us",
       lyrics = content,
...
content= f.read()
f.close()
track2 = Track(title = "The Proof Of Your Love",
       lyrics = content,
...
content= f.read()
f.close()
track3 = Track(title = "It's Not Over Yet",
       lyrics = content,
...
artist6 = Artist(name="Danny Gokey", picture = "iscale.iheart.com/v3/catalog/artist/143568?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track0 = Track(title = "Tell Your Heart to Beat Again",
       lyrics = content,
...
content= f.read()
f.close()
track1 = Track(title = "The Comeback",
       lyrics = content,
...
# Tracks for skillet
artist7 = Artist(name="Skillet", picture = "iscale.iheart.com/v3/catalog/artist/31216?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track2 = Track(title = "Awake and Alive",
       lyrics = content,
...
content= f.read()
f.close()
track3 = Track(title = "The Resistance",
       lyrics = content,
...
artist8 = Artist(name="Hillary Scott & The Scott Family", picture = "iscale.iheart.com/v3/catalog/artist/31192395?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track1 = Track(title = "Untitled Hymn",
       lyrics = content,
...
# Tracks for NF
artist9 = Artist(name="NF", picture = "//iscale.iheart.com/v3/catalog/artist/958998?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track1 = Track(title = "Let You Down",
       lyrics = content,
...
artist10 = Artist(name="Jordan Feliz", picture = "iscale.iheart.com/v3/catalog/artist/30952018?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track2 = Track(title = "Never Too Far Gone",
       lyrics = content,
...
# Tracks for tobyMac
artist11 = Artist(name="TobyMac", picture = "http://iscale.iheart.com/v3/catalog/artist/386996?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track0 = Track(title = "Lights Shine Bright",
       lyrics = content,
...
content= f.read()
f.close()
track3 = Track(title = "City On Our Knees",
       lyrics = content,
...
artist12 = Artist(name="Matthew West", picture = "iscale.iheart.com/v3/catalog/artist/33420?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track0 = Track(title = "Broken Things",
       lyrics = content,
...
content= f.read()
f.close()
track1 = Track(title = "Hello, My Name Is",
       lyrics = content,
...
artist13 = Artist(name="Francesca Battistelli", picture = "iscale.iheart.com/v3/catalog/artist/58911?ops=fit(240%2C240),run(%22circle%22)")
...
content= f.read()
f.close()
track0 = Track(title = "He Knows My Name",
       lyrics = content,
...
content= f.read()
f.close()
track1 = Track(title = "Write Your Story",
       lyrics = content,
...
content= f.read()
f.close()
track2 = Track(title = "Giants Fall",
       lyrics = content,
...
content= f.read()
f.close()
track3 = Track(title = "Free To Be Me",
       lyrics = content,
...
content= f.read()
f.close()
track4 = Track(title = "Beautiful, Beautiful",
       lyrics = content,
